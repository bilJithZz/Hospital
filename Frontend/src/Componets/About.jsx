...
const About = () => {
  return (
    <div className="flex w-screen bg-green-50 h-screen  justify-center items-center gap-4  flex-row">
        <div className="flex flex-col gap-3  text-center justify-center items-center">
             <p className='text-4xl text-customGreen font-bold'>This Is super Speciality</p>  
